...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn blue editable-submit"><i class="icon-check"></i></button>'+
                                '<button type="button" class="btn default editable-cancel"><i class="icon-times"></i></button>';         
...
(function ($) {
    ...
    Date.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/
        ...
        @default 'x clear'
        **/
        clear: 'clear <i class="icon-remove icon-times" style="font-size:12px"></i>'
    });
...
(function ($) {
    ...
    DateTimeField.defaults = $.extend({}, $.fn.editabletypes.datetime.defaults, {
        ...
        @property tpl 
        **/    
        tpl:'<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn date-set default" type="button"><i class="icon-calendar"></i></button></span></div>',
         /**
        @property inputclass 
        @default 'input-medium'
        **/         
